 ...
 * @param dateString
 */
export function dateToIsoDate(dateString: string): string | undefined {
    ...
    return (new Date(isoDate).toISOString().substring(0, 10) === dateOnly.substring(0, 10) && isoDate) || undefined;
}
